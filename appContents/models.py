...
class ButtonRange(db.Model):
    """
    SQLAlchemy model for storing button range settings.

    Attributes:
        id (int): Primary key identifying the button range.
        start (int): Start of the button range.
        end (int): End of the button range.
    """
    id = db.Column(db.Integer, primary_key=True)
